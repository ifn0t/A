...
<!-- Dropdown Structure -->
		...
		<ul id="dropdown2" class="dropdown-content">
		  ...
		  <li class="divider"></li>
		  <li><a href="catalog.php">Tea</a></li>
		</ul>
		  ...
		  <nav class="nav-wrapper white" role="navigation">
			<div class="nav-wrapper">
				...
				<ul class="left hide-on-med-and-down">		
					<li><a href="catalog.php" class="green-text text-darken-3">Yogurt</a></li>
					<li><a href="catalog.php" class="dropdown-button green-text text-darken-3" data-activates="dropdown1">Snacks</a></li>
					<li><a href="catalog.php" class="dropdown-button green-text text-darken-3" data-activates="dropdown2">Drinks</a></li>
				...
				<ul class="right hide-on-med-and-down">		
					<li><a href="sign_in.php" class="dropdown-button green-text text-darken-3" data-activates="dropdown3"><i class="large material-icons green-text text-darken-3">perm_identity</i></a></li>
					<li><a href="cart.php"><i class="large material-icons green-text text-darken-3">shopping_cart</i></a></li>
