...
<head>
  ...
  <title>Just Nature Client</title>
	...
	<div class="section">
	  <div class="container">
			...
			<div class="row">
				<div class="col s12">
				  <ul class="tabs">
					<li class="tab col s3"><a class='acountTabTxt' href="#orderHist">Order History</a></li>
					<li class="tab col s3"><a class='acountTabTxt' href="#reviewHist">Reviews</a></li>
					<li class="tab col s3"><a class='acountTabTxt' href="#settings">Settings</a></li>
				  </ul>
				</div>
			</div>
			<div class="row">				
				<div id="orderHist" class="col s12">
					 <ul class="collection">
						<li class="collection-item avatar">
						  ...
						  <span class="title">vdsdfbjdfbsd fjdsf sdhbfsdhfbs dfhsdbf sdfhdsfds</span>
						  <p><?php echo $price ?></p>
	...
	<form class="col s12">
		<div class="modal-content">
			<h4 class="header orange-text text-darken-3">Edit Address</h4>
				<div class="row">
					<div class="input-field col s12 m6">
							<input id="editFirstName" type="text" data-validation="required" data-validation-error-msg="First name is required">
							<label for="editFirstName">First Name:</label>
					</div>
					<div class="input-field col s12 m6">
						<input id="editLastName" type="text" data-validation="required" data-validation-error-msg="Last name is required">
						<label for="editLastName">Last Name:</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
						<input id="editAddressInput" type="text" data-validation="required" data-validation-error-msg="Address is required">
						<label for="editAddressInput">Address:</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
						<input id="editCity" type="text" data-validation="required" data-validation-error-msg="City is required">
						<label for="editCity">City:</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
						<input id="editZip" type="text" data-validation="custom" data-validation-regexp="^[0-9]{5}(?:-[0-9]{4})?$">
						<label for="editZip">ZIP:</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
						<input id="editCountry" type="text" data-validation="required" data-validation-error-msg="Country is required">
